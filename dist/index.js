...
const nunjucks = __webpack_require__(4)
...
const scale = __webpack_require__(11)
const ICON = {
...
const markers = __webpack_require__(3)
...
module.exports = (function() {(window.nunjucksPrecompiled = window.nunjucksPrecompiled || {})["card/citylist.html"] = (function() {
...
output += "<ul>\n    ";
frame = frame.push();
var t_3 = runtime.contextOrFrameLookup(context, frame, "cities");
...
output += "\n    <li>";
output += runtime.suppressValue(env.getFilter("capitalize").call(context, runtime.memberLookup((t_4),"city_name")), env.opts.autoescape);
output += "</li>\n    ";
;
}
}
